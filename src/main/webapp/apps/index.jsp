...
<<<<<<< HEAD
                <h2 class="animate__animated animate__fadeInDown animate__slower	2s">18:00-24:00</h2>
                <h2 class="animate__animated animate__fadeInLeft animate__slower	2s">完全預約制</h2>
                <h2 class="animate__animated animate__fadeInRight animate__slower	2s">06-xxxxxxxx</h2>
=======
                <h2 class="animate__animated animate__fadeInLeft animate__slower	2s">18:00~24:00完全預約制</h2>
>>>>>>> 40653724bd2a8eedd754dafd913418f962e31fb1
            </div>
